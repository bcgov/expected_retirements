...
-   The expected number of female retirements in a year is $\sum^{a=60}_{a=55}p_a \times w_{af}=32,000$.
...
### The age pyramid illustrates the number of people of each age/sex combination in B.C. Horizontal grey lines indicate the retirement years.
